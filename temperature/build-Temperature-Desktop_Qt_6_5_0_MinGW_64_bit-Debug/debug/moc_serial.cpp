...
Q_CONSTINIT static const qt_meta_stringdata_CLASSserialENDCLASS_t qt_meta_stringdata_CLASSserialENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 11),  // "event_error"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 28),  // "QSerialPort::SerialPortError"
        QT_MOC_LITERAL(49, 5),  // "error"
        QT_MOC_LITERAL(55, 8)   // "readUART"
    },
    "serial",
    "event_error",
    "",
...
void serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->event_error((*reinterpret_cast< std::add_pointer_t<QSerialPort::SerialPortError>>(_a[1]))); break;
        case 1: _t->readUART(); break;
        default: ;
        }
    }
}
